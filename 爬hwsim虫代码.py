...
base_path.append("hwsim")
hwsim_path = "/".join(base_path,)
    ...
    if response.status_code == 200:
        ...
        for target_class in target_class_list:
            ...
            for element in directory:
                ...
                text = element.text
                hwsim_list[text] = href
            for key, value in hwsim_list.items(): 
...
crawl_website_with_structure('https://w1.fi/cgit/hostap/tree/tests/hwsim')
